...
public class API_Tests_StepDeff {
    ...
    public void accept_header_is(String acceptType) {
        if(ConfigurationReader.getProperty("acceptType").equals(acceptType)){
        basicRequest = LibraryAPI_Util.getBasicRequest(userType);}
    ...
    public void requestContentTypeHeaderIs(String reqContentTypeHeader) {
        basicRequest
                .header()
    }
